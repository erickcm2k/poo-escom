...
public class Camion extends Transporte {
    ...
    public void corregirDatos() {
        ...
        */
        ...
        System.out.println("¿Desea modificar la capacidad de carga? (s/n) Actual: " + this.capacidadCarga);
        String r9 = respuesta.nextLine();
        if(r9.equals("s") || r9.equals("S")) {
            System.out.println("Ingrese los nuevos datos de la capacidad de carga.");
            this.capacidadCarga = respuesta.nextInt();
            System.out.println("Nueva capacidad de carga: " + this.capacidadCarga);
        }   

        System.out.println("¿Desea modificar la capacidad de remolque? (s/n) Actual: " + this.capacidadRemolque);
        String r10 = respuesta.nextLine();
        if(r10.equals("s") || r10.equals("S")) {
            System.out.println("Ingrese los nuevos datos de capacidad de remolque.");
            this.capacidadRemolque = respuesta.nextInt();
            System.out.println("Nueva capacidad de remolque: " + this.capacidadRemolque);
        }           
