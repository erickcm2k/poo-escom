    ...
    */
    ...
    public void corregirDatos() {
        ...
        */
        ...
        System.out.println("¿Desea modificar la potencia del vehículo? (s/n) Actual: " + this.potencia);
        String r9 = respuesta.nextLine();
        if(r9.equals("s") || r9.equals("S")) {
            System.out.println("Ingrese los nuevos datos de potencia.");
            this.potencia = respuesta.nextInt();
            System.out.println("Nueva marca es: " + this.potencia);
        }
        
        System.out.println("¿Desea modificar la cilindrada del vehículo? (s/n) Actual: " + this.cilindrada);
        String r10 = respuesta.nextLine();
        if(r10.equals("s") || r10.equals("S")) {
            System.out.println("Ingrese los nuevos datos de cilindrada.");
            this.cilindrada = respuesta.nextInt();
            System.out.println("Nueva marca es: " + this.cilindrada);
        }        
